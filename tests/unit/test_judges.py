...
async def test_regression_judge_flags_matching_signature() -> None:
    ...
    sigs = [{"id": "abc123def456", "summary": "JWT failure", "category": "test_failure",
...
async def test_regression_judge_includes_signatures_in_prompt() -> None:
    ...
    sigs = [{"id": "sig-xyz", "summary": "DB timeout", "category": "flaky",
              "affected_component": "src/db.py", "fragility_score": 0.6}]
    captured: list[list[dict]] = []
