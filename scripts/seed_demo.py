...
SYNTHETIC_FAILURES = [
    ...
    {
        "repo": "curl/curl",
        "job": "deprecation-check",
        "step": "deprecated API usage",
        "exit_code": 1,
        "category": "contract_violation",
